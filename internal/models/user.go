...
type User struct {
	...
	Email      string `json:"email" gorm:"size:16;not null;unique"` // 邮箱，唯一
	...
	Users              []User    `gorm:"many2many:user_follows;joinForeignKey:FollowerID;JoinReferences:FollowedID"` // 关注的用户列表
}
